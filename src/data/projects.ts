...
export const projects: Project[] = [
    {
        ...
        description:
            "Proyecto \"llave en mano\" que incluyó la construcción de oficinas con tablaroca, plomería, red eléctrica y la instalación de sistemas de aire acondicionado. Se ejecutó la fabricación y montaje de un montacarga eléctrico de 500 kg y la aplicación de piso antiestático especializado para entornos de laboratorio.",
        materials:
